...
class AuthenticateCourierController {
  private useCase: AuthenticateCourierUseCase;

  constructor(useCase: AuthenticateCourierUseCase) {
...
export { AuthenticateCourierController };
